...
function main() {
  ...
  gl.uniform3f(u_LightPosition, 1.0, 5.0, 5.0);
  ...
  const Pyramid = createPyramid(
    ...
    [1.0, 1.0, 1.0],
    [
      'resources/blueflower.jpg', // Front face
      'resources/pinkflower.jpg', // Right face
      'resources/redflower.jpg', // Back face
      'resources/yellowflower.jpg', // Left face
    ]
  );
