...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `bdate_before_insert` BEFORE INSERT ON `DEPENDENT` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `bdate_before_update` BEFORE UPDATE ON `DEPENDENT` FOR EACH ROW BEGIN
    IF NEW.bdate > CURDATE() THEN
        SIGNAL SQLSTATE '45000' 
...
--
-- Temporary view structure for view `DEPENDENTS14`
--

DROP TABLE IF EXISTS `DEPENDENTS14`;
/*!50001 DROP VIEW IF EXISTS `DEPENDENTS14`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `DEPENDENTS14` AS SELECT 
 1 AS `Dep_name`,
 1 AS `Bdate`,
 1 AS `ESSN`*/;
...
CREATE TABLE `EMPLOYEE` (
  ...
  CONSTRAINT `fk_dept` FOREIGN KEY (`dno`) REFERENCES `DEPARTMENT` (`dnumber`) ON DELETE SET NULL ON UPDATE CASCADE,
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `capitalize_names_before_insert` BEFORE INSERT ON `EMPLOYEE` FOR EACH ROW BEGIN
...
INSERT INTO `WORKS_ON` VALUES ('12332121',1,15.0),('12332121',2,20.0),('12332121',3,18.0),('123456789',1,32.5),('123456789',2,7.5),('333445555',2,10.0),('333445555',3,10.0),('333445555',10,10.0),('333445555',20,30.0),('453453453',1,20.0),('453453453',2,20.0),('666884444',3,40.0),('888665555',20,NULL),('987654321',20,15.0),('987654321',30,20.0),('987987987',10,35.0),('987987987',30,5.0),('999887777',10,10.0),('999887777',30,30.0);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insert_salary_trigger` AFTER INSERT ON `WORKS_ON` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_salary_trigger` AFTER UPDATE ON `WORKS_ON` FOR EACH ROW BEGIN
    -- Declare a local variable
    SET @total_hours = (
        SELECT SUM(phours)
        FROM WORKS_ON
...
--
-- Final view structure for view `DEPENDENTS14`
--
...
/*!50001 VIEW `DEPENDENTS14` (`Dep_name`,`Bdate`,`ESSN`) AS select `dep`.`dependent_name` AS `dependent_name`,`dep`.`bdate` AS `bdate`,`dep`.`essn` AS `essn` from `DEPENDENT` `dep` where (timestampdiff(YEAR,`dep`.`bdate`,curdate()) < 40) */
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `DEPT_INFO` (`Dept_name`,`n_emps`,`ave_salary`,`max_salary`,`manager_ssn`) AS select `d`.`dname` AS `Dname`,count(`e`.`ssn`) AS `COUNT(e.SSN)`,avg(`e`.`salary`) AS `AVG(e.Salary)`,max(`e`.`salary`) AS `MAX(e.Salary)`,`d`.`mgr_ssn` AS `mgr_ssn` from (`DEPARTMENT` `d` join `EMPLOYEE` `e` on((`d`.`dnumber` = `e`.`dno`))) group by `d`.`dname`,`d`.`mgr_ssn` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-04-05 17:30:37
