...
int main()
{
    ...
    else if (answer == 'N' || answer == 'n')
    {
        ...
        cout << "*** I will type the location number and a question mark (?). You then          ***" << endl;
        cout << "*** type the word for that location. Type the word Go to execute  your program ***" << endl
             << endl;
        cout << "000000 ? ";
    }
    else
